...
DEFAULT_GED = {
    ...
    "reaction_fp_params": {
        "value": None,
        "info": (
            "The default parameters provided by RDKit are used for the specified"
    ...
    "reaction_similarity_name": {
        "value": "tanimoto",
        "info": (
            "The Tanimoto similarity as defined in RDKit is used for computing the "
            "reaction similarity"
        ),
    ...
    "molecular_fp": {
        "value": "rdkit",
        "info": (
            "The molecular fingerprints rdFingerprintGenerator.GetRDKitFPGenerator are"
            " used"
        ),
    ...
    "molecular_fp_count_vect": {
        "value": False,
        "info": (
            "False. If set to True, GetCountFingerprint is used for the molecular "
            "fingerprints"
        ),
        "general_info": (
...
DEFAULT_FACADE = {
    ...
    "distance_matrix": {
        ...
        "info": (
            "The standard NetworkX GED algorithm and the default parameters are used"
        ),
    },
    "clustering": {
        "value": {
        ...
        "info": (
            "AgglomerativeClustering is used when there are less than 15 routes,"
            " hdbscan otherwise.The standard NetworkX algorithm and default parameters"
            " are used for the distance matrixcalculation"
        ),
    },
    "merging": {
