...
class TranslatorMonopartiteReacSynGraph(AbsTranslator):
    ...
    def from_iron(self, iron_route: Iron) -> Union[MonopartiteReacSynGraph, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from Iron to monopartite-reactions SynGraph object"
                ' an empty route was found: "None" returned'
            )
            return None
    ...
    def to_iron(self, mp_syngraph: MonopartiteReacSynGraph) -> Union[Iron, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from a monopartite-reactions SynGraph to Iron an"
                ' empty route was found: "None" returned'
            )
            return None
...
class TranslatorBipartiteSynGraph(AbsTranslator):
    ...
    def from_iron(self, iron_route: Iron) -> Union[BipartiteSynGraph, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from Iron to bipartite SynGraph object an empty"
                ' route was found: "None" returned'
            )
            return None
    ...
    def to_iron(self, syngraph: BipartiteSynGraph) -> Union[Iron, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from a bipartite SynGraph to Iron an empty route was"
                ' found: "None" returned'
            )
            return None
...
class TranslatorMonopartiteMolSynGraph(AbsTranslator):
    ...
    def from_iron(self, iron_route: Iron) -> Union[MonopartiteMolSynGraph, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from Iron to a monopartite-molecules SynGraph object"
                ' an empty route was found: "None" returned'
            )
            return None
    ...
    def to_iron(self, mp_syngraph: MonopartiteMolSynGraph) -> Union[Iron, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from a monopartite-molecules SynGraph to Iron an"
                ' empty route was found: "None" returned'
            )
            return None
...
class TranslatorNetworkx(AbsTranslator):
    ...
    def from_iron(self, route_iron: Iron) -> Union[nx.classes.digraph.DiGraph, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from Iron to NetworkX object an empty route was"
                ' found: "None" returned'
            )
            return None
...
class TranslatorDot(AbsTranslator):
    ...
    def from_iron(self, route_iron: Iron) -> Union[pydot.Dot, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from Iron to PyDot object an empty route was found:"
                ' "None" returned'
            )
            return None
...
class TranslatorIbm(AbsTranslator):
    ...
    def to_iron(self, route: dict) -> Union[Iron, None]:
        ...
        try:
            ...
            logger.warning(
                'While translating from IBM to Iron an empty route was found: "None"'
                " returned"
            )
            return None
        except InvalidRoute:
            logger.warning(
                "While translating from IBM to Iron an invalid route containing only"
                ' one molecule was found: "None" returned'
            )
            return None
...
class TranslatorAz(AbsTranslator):
    ...
    def to_iron(self, route: dict) -> Union[Iron, None]:
        ...
        try:
            ...
            logger.warning(
                'While translating from AZ to Iron an empty route was found: "None"'
                " returned"
            )
            return None
...
class TranslatorMit(AbsTranslator):
    ...
    def to_iron(self, route: dict) -> Union[Iron, None]:
        ...
        try:
            ...
            logger.warning(
                'While translating from Asckos to Iron an empty route was found: "None"'
                " returned"
            )
            return None
...
class TranslatorNOC(AbsTranslator):
    ...
    def from_iron(self, route_iron: Iron) -> Union[dict, None]:
        ...
        try:
            ...
            logger.warning(
                "While translating from Iron to NOC format an empty route was found:"
                ' "None" returned'
            )
            return None
...
class TranslatorDotVisualization(AbsTranslator):
    ...
    def from_iron(self, route_iron: Iron) -> None:
        ...
        try:
            ...
            os.system(
                f"dot -Tpng route_{route_iron.source}.dot >"
                f" route_{route_iron.source}.png"
            )
            ...
            logger.warning(
                "While translating from Iron to PyDot-visualization format- an empty"
                ' route was found: "None" returned'
            )
            return None
...
class TranslatorFactory:
    ...
    translators = {
        ...
        "noc": {
            "value": TranslatorNOC,
            "info": (
                "Translating to a format compatible with a Network of Organic Chemistry"
            ),
        },
    }
    ...
    def select_translation_to_iron(self, input_format: str, graph, out_data_model: str):
        ...
        if input_format not in self.translators:
            logger.error(
                f"'{input_format}' is not a valid input format. Possible formats are:"
                f" {self.translators.keys()}"
            )
    ...
    def select_translation_from_iron(
        ...
        if out_format not in self.translators:
            logger.error(
                f"'{out_format}' is not a valid output format. Possible formats are:"
                f" {self.translators.keys()}"
            )
