    ...
    def get_available_options(self) -> dict:
        ...
        return {
            "routes": {
                ...
                "choices": None,
                "help": (
                    "List of SynGraph objects for which the selected descriptors should"
                    " be calculated"
                ),
                "dest": "routes",
            },
...
class GedFacade(Facade):
    ...
    info = (
        "To compute the distance matrix of a list of SynGraph objects via a Graph Edit"
        " Distance algorithm"
    )
    ...
    def get_available_options(self) -> dict:
        ...
        return {
            "routes": {
                ...
                "choices": None,
                "help": (
                    "List of SynGraph objects for which the distance matrix should be"
                    " calculated"
                ),
                "dest": "routes",
            },
    ...
    def get_available_options(self) -> dict:
        return {
            "routes": {
                ...
                "choices": None,
                "help": (
                    "List of SynGraph objects in which duplicates should be searched"
                ),
                "dest": "routes",
            }
        }
    ...
    def get_available_options(self) -> dict:
        return {
            "routes": {
                ...
                "choices": None,
                "help": (
                    "List of SynGraph objects from which reaction strings should be"
                    " extracted"
                ),
                "dest": "routes",
            }
