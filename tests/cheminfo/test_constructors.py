...
def test_molecular_hashing():
    ...
    reference = {
        "ma1": {
            ...
            "HetAtomTautomer": (
                "CCC1CC([C]([O])[C]2[CH][CH][CH][C](C)[CH]2)CC[C]1[O]_0_0"
            ),
        ...
        "ma3": {
            ...
            "HetAtomProtomer": (
                "C=C(C)C([C]1[CH][CH][CH][CH][CH]1)[S]([O])C[C]([N])[O]_2"
            ),
            "HetAtomTautomer": (
                "C=C(C)C([C]1[CH][CH][CH][CH][CH]1)[S]([O])C[C]([N])[O]_2_0"
            ),
        ...
        "ma4": {
            ...
            "HetAtomTautomer": (
                "C[C]1[CH][CH][CH][C](C(C2CCC([N])CC2)C(F)(F)F)[CH]1_2_0"
            ),
        ...
        "ma5": {
            ...
            "HetAtomProtomer": (
                "C[N]C1CCC([C]2[CH][CH][C](Cl)[C](Cl)[CH]2)[C]2[CH][CH][CH][CH][C]21_1"
            ),
            "HetAtomTautomer": "C[N]C1CCC([C]2[CH][CH][C](Cl)[C](Cl)[CH]2)[C]2[CH][CH][CH][CH][C]21_1_0",
            "Mesomer": (
                "CNC1CCC([C]2[CH][CH][C](Cl)[C](Cl)[CH]2)[C]2[CH][CH][CH][CH][C]21_0"
            ),
            "MolFormula": "C17H17Cl2N",
            "MurckoScaffold": "c1ccc(C2CCCc3ccccc32)cc1",
            "NetCharge": "0",
            "RedoxPair": (
                "CNC1CCC([C]2[CH][CH][C](Cl)[C](Cl)[CH]2)[C]2[CH][CH][CH][CH][C]21"
            ),
        ...
        "sa1": {
            ...
            "inchi_KET_15T": (
                "InChI=1/C5H11ClO/c1-3-4(2)5(6)7/h4-5,7H,3H2,1-2H3/t4-,5+/m1/s1"
            ),
        ...
        "sa4": {
            ...
            "inchi_KET_15T": (
                "InChI=1/C5H11ClO/c1-3-4(2)5(6)7/h4-5,7H,3H2,1-2H3/t4-,5-/m0/s1"
            ),
        ...
        "tc1": {
            ...
            "inchi": (
                "InChI=1S/C9H12O3/c1-5-3-4-7(11)8(6(2)10)9(5)12/h5,12H,3-4H2,1-2H3"
            ),
        ...
        "tc3": {
            ...
            "inchi": (
                "InChI=1S/C9H12O3/c1-5-3-4-7(11)8(6(2)10)9(5)12/h5,11H,3-4H2,1-2H3"
            ),
            "inchi_KET_15T": "InChI=1/C9H12O3/c1-5-3-4-7(11)8(6(2)10)9(5)12/h3H2,1-2H3,(H4,4,5,8,10,11,12)",
...
def test_disconnection_equality():
    test_set = [
        ...
        },
        {
            ...
            "smiles": (
                "[CH3:6][CH:7]=[CH2:8].[CH3:1][C:2](=[CH2:3])[CH:4]=[CH2:5]>>[CH3:6][CH:7]1[CH2:8][CH2:3][C:2](=[CH:4][CH2:5]1)[CH3:1] "
            ),
            "expected": {},
        },
        {
...
def test_disconnection():
    test_set = {
        ...
        "rxn_10": {
            "smiles": (
                "C[O:1][CH2:2][CH2:3][CH2:4][O:5]C>>[OH:5][CH2:4][CH2:3][CH2:2][OH:1]"
            ),
        },
    ...
    for a, b in couples:
        ...
        assert a != b, (
            "You are comparing the same thing, please review the reaction_list in the"
            f" test set:  {a} {b}"
        )
        ...
        assert disconnection_a.uid != disconnection_b.uid, (
            ...
            + f"{a}: {disconnection_a.uid} \n{b}: {disconnection_b.uid} \n"
        )
        assert disconnection_a.hash_map.get(
            "disconnection_summary"
        ) != disconnection_b.hash_map.get("disconnection_summary"), (
            f"The disconnection summary is the same for some reactions that have the"
            f" same products but different reactants: \n"
    ...
    for a, b in couples:
        ...
        disconnection_b = chemical_equation_b.disconnection
        assert a != b, (
            "You are comparing the same thing, please review the reactions selected"
            f" from test set:  {a} {b}"
        )

        assert disconnection_a.molecule.uid != disconnection_b.molecule.uid, (
            "We expect the product to be different "
